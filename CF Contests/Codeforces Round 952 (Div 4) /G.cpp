...
int solve(int tc)
{
    ...
    // bro ran a brute force to catch the pattern 
    // how did he know a pattern would exist 
    // 
    ...
    result = (right-left+m)%m;

    cout<<result<<endl;

    // result = m_sub(right,left);

    // cout<<result<<endl ;             // this is giving wrong answer i dont know why
